...
if __name__ == '__main__':
    ...
    #bins= int(df_etf['performance_rating'].max())
    ...
    sns.barplot(df_etf_bench.values,df_etf_bench.index, palette="muted" )
    ...
    plt.figure(figsize=(15,15),dpi=150)
    sns.barplot(df_mfund_bench.values,df_mfund_bench.index, palette="muted")
    ...
    sns.violinplot(x=df_mfund_cat['category'],y=df_mfund_cat['sustainability_score'],
                   palette='muted')
    ax6.set_ylabel(ylabel='ESG score', fontsize=10)
    ...
    sns.violinplot(x=df_etf_cat['category'],y=df_etf_cat['sustainability_score']
                   ,palette='muted')
    ...
    sns.violinplot(x=df_etf_cat['category'],y=df_etf_cat['social_score']
                   ,palette='muted')
    ...
    sns.violinplot(x=df_mfund_cat['category'],y=df_mfund_cat['social_score']
                   ,palette='muted')
    ...
    sns.boxplot(x=df_etf_cat['category'],y=df_etf_cat['governance_score']
                ,palette='muted')
    ...
    sns.boxplot(x=df_mfund_cat['category'],y=df_mfund_cat['governance_score']
                ,palette='muted')
    ...
    sns.boxplot(x=df_etf_cat['category'],y=df_etf_cat['fund_trailing_return_ytd']
                ,palette='muted')
    ax20.set_ylabel(ylabel='YTD return (%)', fontsize=10)
    ...
    sns.boxplot(x=df_etf_cat['category'],y=df_etf_cat['fund_trailing_return_3years']
                ,palette='muted')
    ax21.set_ylabel(ylabel='3-years return (%)', fontsize=10)
    ...
    sns.boxplot(x=df_mfund_cat['category'],y=df_mfund_cat['fund_trailing_return_ytd']
                ,palette='muted')
    ax23.set_ylabel(ylabel='YTD return (%)', fontsize=10)
    ...
    sns.boxplot(x=df_mfund_cat['category'],y=df_mfund_cat['fund_trailing_return_3years']
                ,palette='muted')
    ax25.set_ylabel(ylabel='3-years return (%)', fontsize=10)
